...
/* DCX Pin mapping */
#define LCD_DCX_GPIO_PORT                   GPIOF
#define LCD_DCX_GPIO_PIN                    GPIO_PIN_12

/* RESET Pin mapping */
#define LCD_RESET_GPIO_PORT                 GPIOD
#define LCD_RESET_GPIO_PIN                  GPIO_PIN_15
...
#define LCD_RST_LOW()                       WRITE_REG(GPIOD->BSRR, (uint32_t)GPIO_PIN_15 << 16)
#define LCD_RST_HIGH()                      WRITE_REG(GPIOD->BSRR, GPIO_PIN_15)

/* Chip Select macro definition */
#define LCD_CS_LOW()                        WRITE_REG(GPIOD->BSRR, (uint32_t)GPIO_PIN_14 << 16)
#define LCD_CS_HIGH()                       WRITE_REG(GPIOD->BSRR, GPIO_PIN_14)

/* Data/Command macro definition */
#define LCD_DC_LOW()                        WRITE_REG(GPIOF->BSRR, GPIO_PIN_12)
#define LCD_DC_HIGH()                       WRITE_REG(GPIOF->BSRR, (uint32_t)GPIO_PIN_12 << 16)
